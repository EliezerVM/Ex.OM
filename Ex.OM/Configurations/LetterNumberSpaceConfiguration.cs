...
{
    public static class LetterNumberSpaceConfiguration
    {
        public static void AddLetterNumberSpace(this TextBox textBox)
        {

            textBox.Text = textBox.Text.LetterNumberSpace().CharacterCasingSwich(textBox.CharacterCasing);
        ...
        public static void RemoveLetterNumberSpace(this TextBox textBox)
        {
            textBox.PreviewTextInput -= TextBox_PreviewTextInput;
            textBox.LostFocus -= TextBox_LostFocus;
            textBox.PreviewKeyDown -= TextBox_PreviewKeyDown;
        ...
        private static void OnPaste(object sender, DataObjectPastingEventArgs e)
        {
            ...
            d.SetData(DataFormats.Text, data.LetterNumberSpace());
            e.DataObject = d;
        ...
        private static void TextBox_PreviewTextInput(object sender, System.Windows.Input.TextCompositionEventArgs e)
        {
            ...
            textBox.Text = options.data.LetterNumberSpace().CharacterCasingSwich(textBox.CharacterCasing);
        ...
        {
            if (!(sender is TextBox textBox)) return;
            textBox.Text.LetterNumberSpace(textBox.CharacterCasing == CharacterCasing.Upper);
        }
        ...
        private static void TextBox_PreviewKeyDown(object sender, System.Windows.Input.KeyEventArgs e)
        {
            ...
            if (!e.IsLetter() && !e.IsNumber() && !DigitConfiguration.IsControl && e.Key != System.Windows.Input.Key.Space) { e.Handled = true; return; }
