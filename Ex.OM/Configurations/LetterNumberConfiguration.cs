...
{
    public static class LetterNumberConfiguration
    {
        public static void AddLetterNumber(this TextBox textBox)
        {

            textBox.Text = textBox.Text.LetterNumber().CharacterCasingSwich(textBox.CharacterCasing);
        ...
        public static void RemoveLetterNumber(this TextBox textBox)
        {
            textBox.PreviewTextInput -= TextBox_PreviewTextInput;
            textBox.LostFocus -= TextBox_LostFocus;
            textBox.PreviewKeyDown -= TextBox_PreviewKeyDown;
        ...
        private static void OnPaste(object sender, DataObjectPastingEventArgs e)
        {
            ...
            d.SetData(DataFormats.Text, data.LetterNumber());
            e.DataObject = d;
        ...
        private static void TextBox_PreviewTextInput(object sender, System.Windows.Input.TextCompositionEventArgs e)
        {
            ...
            textBox.Text = options.data.LetterNumber().CharacterCasingSwich(textBox.CharacterCasing);
        ...
        private static void TextBox_PreviewKeyDown(object sender, System.Windows.Input.KeyEventArgs e)
        {
            ...
            if (!e.IsLetter() && !e.IsNumber() && !DigitConfiguration.IsControl) { e.Handled = true; return; }
