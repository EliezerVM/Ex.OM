...
{
    public static class OnlyLetterCapitalizerSpaceConfiguration
    {
        public static void AddOnlyLetterCapitalizerSpace(this TextBox textBox)
        {
        ...
        public static void RemoveOnlyLetterCapitalizerSpace(this TextBox textBox)
        {
            textBox.PreviewTextInput -= TextBox_PreviewTextInput;
            textBox.LostFocus -= TextBox_LostFocus;
            textBox.PreviewKeyDown -= TextBox_PreviewKeyDown;
        ...
        private static void OnPaste(object sender, DataObjectPastingEventArgs e)
        {
            ...
            d.SetData(DataFormats.Text, data.OnlyLetterCapitalizerSpace());
            e.DataObject = d;
        }
        ...
        private static void TextBox_PreviewTextInput(object sender, System.Windows.Input.TextCompositionEventArgs e)
        {
            ...
            textBox.Text = options.data.OnlyLetterCapitalizerSpace();
        ...
        {
            if (!(sender is TextBox textBox)) return;
            textBox.Text.OnlyLetterCapitalizerSpace();
        }
