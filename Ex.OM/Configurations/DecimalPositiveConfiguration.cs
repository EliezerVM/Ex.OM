...
{
    public static class DecimalPositiveConfiguration
    {
        public static void AddDecimalPositive(this TextBox textBox)
        {
            ...
            var options = textBox.Text.DecimalPositive(decimals);
        ...
        public static void RemoveDecimalPositive(this TextBox textBox)
        {
            textBox.PreviewTextInput -= DecimalConfiguration.TextBox_PreviewTextInput;
            textBox.LostFocus -= DecimalConfiguration.TextBox_LostFocus;
            textBox.PreviewKeyDown -= DecimalConfiguration.TextBox_PreviewKeyDown;
