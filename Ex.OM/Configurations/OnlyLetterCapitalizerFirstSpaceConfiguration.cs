...
{
    public static class OnlyLetterCapitalizerFirstSpaceConfiguration
    {
        public static void AddOnlyLetterCapitalizerFirstSpace(this TextBox textBox)
        {

            textBox.Text = textBox.Text.OnlyLetterCapitalizerFirstSpace();
        ...
        public static void RemoveOnlyLetterCapitalizerFirstSpace(this TextBox textBox)
        {
            textBox.PreviewTextInput -= TextBox_PreviewTextInput;
            textBox.LostFocus -= TextBox_LostFocus;
            textBox.PreviewKeyDown -= TextBox_PreviewKeyDown;
        ...
        private static void OnPaste(object sender, DataObjectPastingEventArgs e)
        {
            ...
            d.SetData(DataFormats.Text, data.OnlyLetterCapitalizerFirstSpace());
            e.DataObject = d;
        }
        ...
        private static void TextBox_PreviewTextInput(object sender, System.Windows.Input.TextCompositionEventArgs e)
        {
            ...
            textBox.Text = options.data.OnlyLetterCapitalizerFirstSpace();
        ...
        {
            if (!(sender is TextBox textBox)) return;
            textBox.Text.OnlyLetterCapitalizerFirstSpace();
        }
