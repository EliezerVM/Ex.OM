...
{
    public static class CapitalizerConfiguration
    {


        public static void AddCapitalizer(this TextBox textBox)
        {
          
            textBox.Text =textBox.Text.Capitalizer();   
        ...
        public static void RemoveCapitalizer(this TextBox textBox)
        {
            textBox.PreviewTextInput -= TextBox_PreviewTextInput;
            textBox.LostFocus -= TextBox_LostFocus;
            textBox.PreviewKeyDown -= TextBox_PreviewKeyDown;
        ...
        private static void OnPasteCapitalizerFirst(object sender, DataObjectPastingEventArgs e)
        {
            ...
            d.SetData(DataFormats.Text, data.Capitalizer());
            e.DataObject = d;
        ...
        private static void TextBox_PreviewTextInput(object sender, System.Windows.Input.TextCompositionEventArgs e)
        {
            ...
            textBox.Text = options.data.Capitalizer();
