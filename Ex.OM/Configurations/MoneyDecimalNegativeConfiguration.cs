...
{
    public static class MoneyDecimalNegativeConfiguration
    {
        public static void AddMoneyDecimalNegative(this TextBox textBox)
        ...
        public static void RemoveMoneyDecimalNegative(this TextBox textBox)
        {
            textBox.PreviewTextInput -= MoneyDecimalConfiguration.TextBox_PreviewTextInput;
            textBox.PreviewKeyDown -= MoneyDecimalConfiguration.TextBox_PreviewKeyDown;
