...
{
    public static class OnlyLetterUpperSpaceConfiguration
    {
        public static void AddOnlyLetterUpperSpace(this TextBox textBox)
        {

            textBox.Text = textBox.Text.OnlyLetterUpperSpace();
        ...
        public static void RemoveOnlyLetterUpperSpace(this TextBox textBox)
        {
            textBox.PreviewTextInput -= TextBox_PreviewTextInput;
            textBox.LostFocus -= TextBox_LostFocus;
            textBox.PreviewKeyDown -= TextBox_PreviewKeyDown;
        ...
        private static void OnPaste(object sender, DataObjectPastingEventArgs e)
        {
            ...
            d.SetData(DataFormats.Text, data.OnlyLetterUpperSpace());
            e.DataObject = d;
        ...
        private static void TextBox_PreviewTextInput(object sender, System.Windows.Input.TextCompositionEventArgs e)
        {
            ...
            textBox.Text = options.data.OnlyLetterUpperSpace();
        ...
        {
            if (!(sender is TextBox textBox)) return;
            textBox.Text.OnlyLetterUpperSpace();
        }
