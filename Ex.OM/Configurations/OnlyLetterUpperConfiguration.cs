...
{
    public static class OnlyLetterUpperConfiguration
    {


        public static void AddOnlyLetterUpper(this TextBox textBox)
        {

            textBox.Text = textBox.Text.OnlyLetterUpper();
        ...
        public static void RemoveOnlyLetterUpper(this TextBox textBox)
        {
            textBox.PreviewTextInput -= TextBox_PreviewTextInput;
            textBox.LostFocus -= TextBox_LostFocus;
            textBox.PreviewKeyDown -= TextBox_PreviewKeyDown;
        ...
        private static void OnPasteCapitalizerFirst(object sender, DataObjectPastingEventArgs e)
        {
            ...
            d.SetData(DataFormats.Text, data.OnlyLetterUpper());
            e.DataObject = d;
        ...
        {
            if (!(sender is TextBox textBox)) return;
            if (!e.Text.IsLetter()) { e.Handled = true; return; }
            var options = textBox.InitializeTextInput(e);
            textBox.Text = options.data.OnlyLetterUpper();
