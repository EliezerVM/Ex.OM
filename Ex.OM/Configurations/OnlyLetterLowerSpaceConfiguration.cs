...
{
    public static class OnlyLetterLowerSpaceConfiguration
    {

        public static void AddOnlyLetterLowerSpace(this TextBox textBox)
        {

            textBox.Text = textBox.Text.OnlyLetterLowerSpace();
        ...
        public static void RemoveOnlyLetterLowerSpace(this TextBox textBox)
        {
            textBox.PreviewTextInput -= TextBox_PreviewTextInput;
            textBox.LostFocus -= TextBox_LostFocus;
            textBox.PreviewKeyDown -= TextBox_PreviewKeyDown;
        ...
        private static void OnPaste(object sender, DataObjectPastingEventArgs e)
        {
            ...
            d.SetData(DataFormats.Text, data.OnlyLetterLowerSpace());
            e.DataObject = d;
        ...
        private static void TextBox_PreviewTextInput(object sender, System.Windows.Input.TextCompositionEventArgs e)
        {
            ...
            textBox.Text = options.data.OnlyLetterLowerSpace();
        ...
        {
            if (!(sender is TextBox textBox)) return;
            textBox.Text.OnlyLetterLowerSpace();
        }
